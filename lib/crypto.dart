...
AsymmetricKeyPair<RSAPublicKey, RSAPrivateKey> generateRSAKeyPair(
  SecureRandom secureRandom, {int bitLength = 1024}){
...
String encrypt(RSAPublicKey publicKey, String dataToEncrypt){
  ...
  var ciphertext = encryptor.process(Uint8List.fromList(dataToEncrypt.codeUnits));
...
String decrypt(RSAPrivateKey privateKey, String cipherText){
  ...
  var decryptedText = decryptor.process(Uint8List.fromList(cipherText.codeUnits));
